                ...
                <tbody>
                    @forelse($visitors as $visitor)
                        <tr>
                            ...
                            <td>
                                @if($visitor->status === 1)
                                <span class="badge badge-danger badge-rounded">Saiu {{ $visitor->updated_at ? $visitor->updated_at->format('H:i') : '-' }}</span>
                                
                                @else
                                <span class="badge badge-success badge-rounded">Entrou {{ $visitor->created_at ? $visitor->created_at->format('H:i') : '-' }}</span>
                                @endif
                            </td>
