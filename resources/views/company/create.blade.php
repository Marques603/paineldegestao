...
<x-app-layout>
    <x-page-title page="Lista de Empresas" pageUrl="{{ route('company.index') }}" header="Criar Empresa" />
                    ...
                    <form method="POST" action="{{ route('company.store') }}" class="flex flex-col gap-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <label class="label">
                                ...
                                <input type="text" name="name" class="input @error('name') border-red-500 @enderror" value="{{ old('name') }}" />
                                @error('name')
                            ...
                            <label class="label">
                                ...
                                <input type="text" name="description" class="input @error('description') border-red-500 @enderror" value="{{ old('description') }}" />
                                @error('description')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <label class="label">
                                ...
                                <input type="text" name="cnpj" class="input @error('cnpj') border-red-500 @enderror" value="{{ old('cnpj') }}" />
                                @error('cnpj')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </label>
